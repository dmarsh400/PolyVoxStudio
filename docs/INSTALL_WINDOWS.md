...
| NVIDIA GPU (optional) | Driver ≥ 520 for CUDA 11.8, ≥ 535 for CUDA 12.1. CPU installs are fully supported. |
...
2. Prompts for a PyTorch runtime (CUDA 11.8, CUDA 12.1, or CPU).
...
5. Downloads the `en_core_web_sm` spaCy language model.
