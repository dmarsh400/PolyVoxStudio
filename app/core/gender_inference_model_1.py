...
import os
from app.core.pipelines import Token
...
class GenderEM:
	...
	def __init__(self, outfile=None, tokens=None, entities=None, entityFiles=None, tokenFiles=None, hyperparameterFile=None, distance=25, num_epochs=25, refs=None, upper=10, use_tagged_pronouns_only=True, genders=[["he", "him", "his"],["she", "her"],	["they", "them", "their"]] ):
		...
		self.honorifics={"mr.":1, "mrs.":1, "miss":1, "lady":1, "sir":1, "captain":1, "mr":1, "lord":1, "aunt":1, "madame":1, "mrs":1, "uncle":1, "colonel":1, "monsieur":1, "mademoiselle":1, "general":1, "major":1, "sergeant":1, "ms.":1,  "herr":1, "frau":1, "fräulein":1, "dame":1, "mister":1, "master":1, "mistress":1, "prince":1, "princess":1, "lieutenant":1 }
				...
				if idd != -1:
					...
					for text in counts[idd]:
						...
						if first_name_token in self.honorific_priors:
							for f in range(self.num_genders):
								mf[f]=self.honorific_priors[first_name_token][f] * counts[idd][text] * 50
